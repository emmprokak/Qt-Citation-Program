...
void MainWindow::prepare_menu_gui()
{
    ...
    ui->button_book->setFixedSize(90,90);
    ui->button_book->setIconSize(QSize(82,82));
    ui->button_paper->setIcon(icon_paper);
    ui->button_paper->setFixedSize(90,90);
    ui->button_paper->setIconSize(QSize(82,82));
    ui->button_chapter->setIcon(icon_chapter);
    ui->button_chapter->setFixedSize(90,90);
    ui->button_chapter->setIconSize(QSize(82,82));
    ui->button_info->setIcon(icon_info);
    ui->button_info->setIconSize(img_chapter.rect().size());
